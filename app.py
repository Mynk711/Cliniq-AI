...
st.markdown("""
<style>
/* Hide top bar but keep sidebar toggle visible */
[data-testid="stHeader"] { background-color: #07132A !important; border-bottom: 1px solid #183560; }
...
/* Sidebar collapse button — keep it visible */
[data-testid="collapsedControl"] { color: #1AC8D4 !important; background-color: #0A1F3D !important; border: 1px solid #183560 !important; }
button[kind="header"] { color: #1AC8D4 !important; }
/* Text */
h1, h2, h3 { color: #EFF6FF !important; }
p, span, label, li { color: #EFF6FF !important; }
